...
Object.defineProperties(Request.prototype, {
  ...
  hostname: {
    get () {
        ...
        if ( host.startsWith( '[' ) ) {
            ...
            return host.substring( 1, closeBracketIndex );
        }
  ...
  port: {
    get () {
        const host = this.host || this.headers.host || this.headers[ ':authority' ];
        ...
        if ( host.startsWith( '[' ) ) {
            ...
            /* No port specified */
            if ( closeBracketIndex === host.length - 1 ) {
                return null;
            }
            
            /* No port separator */
            if ( host[ closeBracketIndex + 1 ] !== ':' ) {
                return null;
            }
            
            const port = Number.parseInt( host.substring( closeBracketIndex + 2 ) );
        ...
        const port = Number.parseInt( host.substring( lastColon + 1 ) );
